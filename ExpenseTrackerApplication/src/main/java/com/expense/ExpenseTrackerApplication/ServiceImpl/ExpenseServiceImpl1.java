...
@Service
@Transactional
public class ExpenseServiceImpl1 {
    private static final Logger logger = LoggerFactory.getLogger(ExpenseServiceImpl1.class);
    private final ExpenseRepository expenseRepository;
    private final UserRepository userRepository;

    public ExpenseServiceImpl1(ExpenseRepository expenseRepository, UserRepository userRepository) {
